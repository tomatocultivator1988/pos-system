-- 00011: Fix addon qty * parent qty, variant binding, addon validation
-- Fixes critical money/stock bugs: addon line_total and stock were not multiplied by parent item qty
